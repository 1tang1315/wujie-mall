...
const Home = () => (
  <div>
    ...
    <p>
      <Button onClick={() => window.open('https://github.com/Tencent/wujie/tree/master/examples/react17')}>仓库地址</Button>
    </p>
  </div>
)
...
function Nav() {
  ...
  return (
    <nav>
      <NavLink to="/home">首页</NavLink> | <NavLink to="/dialog">弹窗</NavLink> | <NavLink to="/location">路由</NavLink> | <NavLink to="/communication">通信</NavLink> | <NavLink to="/state">状态</NavLink>
    </nav>
  )
}
